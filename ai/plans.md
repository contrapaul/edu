...
- **Page one (2026-09-22).** `sample.html` is page one. `index.html` (the plain version) is superseded and now redirects to the sample (merged 2026-09-22).
...
| File | What |
|---|---|
| `sample.html` | Page one, all nine screens built, plus the one-off activities. |
| `index.html` | Redirect to `sample.html`. The plain version was superseded when the sample became page one. |
