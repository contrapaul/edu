...
const COMPONENT_LIBRARY = {
  ...
  hw371: {
    ...
    maxInstances: 4,
    libraries: [],
    description: 'HW-371 45mm slide potentiometer. Analog output. Use an ADC-capable GPIO. Connect VCC to 3V3, GND to GND, wiper (middle/OUT pin) to analog GPIO.',
    pinGroups: [
