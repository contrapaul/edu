...
in `../pages.js`. The book is *Twin Paths of Aethelgard*, pages 1–30:
...
Record the two paragraphs of the page; the choice buttons are read by the
reader, not narrated.

If a page needs a differently named file, add an `audio` field to that
page in `pages.js`, e.g. `audio: "audio/page-7-retake.mp3"`.
