...
const CYOA_PAGES = {
  ...
  2: {
    ...
    choices: [
      { label: "To take the riddles away and practice alone, turn to page 3", page: 3 },
  ...
  4: {
    paragraphs: [
      "Kaelen discovers Master Thorne has left behind a hidden journal beneath his bed. It’s filled with sketches of twin sigils, one glowing and one sharp and angular, and notes about “the guardians who split the realm.”",
  ...
  5: {
    paragraphs: [
      "Lyra trains through the night, her spear moving like a blur in the moonlight. She is not learning how to fight. She is learning what it means to protect.",
  ...
  9: {
    paragraphs: [
      "Kaelen and Lyra read the rest of Master Thorne’s journal together, piecing together the truth about their lineage. The Aethelgard guardians were never only warriors and mages. They were twin aspects of a single power, split when the realm was young to prevent either from becoming tyrants.",
  ...
  15: {
    paragraphs: [
      ...
      "The power responds to balance, and the balance it wants is inside him rather than between the two traditions. With practice and guidance from the academy students, Kaelen learns to harmonize his emotions with his magic.",
    ],
    choices: [
  ...
  16: {
    paragraphs: [
      ...
      "When a training dummy shatters into splinters from her strike, she realizes her power has grown significantly. But with greater ability comes greater responsibility, because others are being hunted for what they are becoming.",
    ],
    choices: [
  ...
  24: {
    paragraphs: [
      ...
      "Master Thorne watches as Kaelen and Lyra demonstrate true mastery. They have not chosen between magic and martial arts. They have made the two work as one.",
    ],
    choices: [
  ...
  25: {
    paragraphs: [
      ...
      "They can return to their original paths, Kaelen back to solitary magic study and Lyra back to martial training, or they can stay together and help rebuild Aethelgard as a kingdom where both magic and martial traditions coexist equally.",
    ],
    choices: [
  ...
  27: {
    paragraphs: [
      ...
      "Their separation was never a punishment. It was a solution. Now they must choose whether to bring them back together or keep them separate forever.",
    ],
    choices: [
  ...
  28: {
    paragraphs: [
      ...
      "Kaelen smiles. “We live. We train together. We protect this world where both magic and martial arts can exist.” Their shadows stand together behind them, side by side at last.",
    ],
    choices: [
  ...
  30: {
    paragraphs: [
      ...
      "Behind them, Master Thorne teaches new students in the academy courtyard below; ahead, the road stretches into an uncertain future where they’ll face new challenges but never alone. Their shadows stand together behind them, a testament to what happens when two halves choose to become whole.",
    ],
    ending: true,
  },
