...
html += `<div class="form-section config2-section"> <div class="form-section-title config2-title">-- CONFIG 2 (optional second action set)</div>`;
...
return `<div class="form-row"><label class="form-label">${schema.label}</label> <select class="form-select" onchange="onConfigChange(${instId},'${key}',this.value)">${opts}</select></div> <div class="form-row"><label class="form-label">or type custom</label> <input class="form-input" type="text" value="${value||''}" placeholder="e.g. notepad or /usr/bin/app" onchange="onConfigChange(${instId},'${key}',this.value)"></div> <div class="launch-hint">On Windows use the exe name (e.g. <code>notepad</code>). On Mac use the app name as it appears in /Applications (e.g. <code>Safari</code>). On Linux use the terminal command (e.g. <code>gedit</code>).</div>`;
