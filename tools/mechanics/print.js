...
(function () {
  ...
  var CRITERIA = [
    { code: 'Ai', task: 'Justify the need for a new game',
      blurb: 'Students choose an audience and find a client group, then conduct research to support the development of a new game.' },
    { code: 'Aii', task: 'Plan and prioritise research',
      blurb: 'Students plan their research methods and topics before designing anything. They provide explanations for their choices, then begin their chosen research tasks.' },
    { code: 'Aiii', task: 'Analyse existing games',
      blurb: 'Students analyse three existing games against the same set of questions. The games must appeal to their target audience and be able to assist in the development of their new game.' },
    { code: 'Aiv', task: 'Write the design brief',
      blurb: 'Students write a design brief that ties their research, analysis, and client details together. It sets out what the game is for and who it is for, drawing on the analysis behind it.' },
    { code: 'Bi', task: 'Write design specifications',
    ...
    { code: 'Bii', task: 'Generate a range of ideas',
      blurb: 'Students develop a range of different game ideas and annotate them. The annotation has to be clear enough that another designer could build from the notes and drawings alone.' },
    ...
    { code: 'Biv', task: 'Production drawings and diagrams',
    ...
    { code: 'Ci', task: 'Plan the build',
      blurb: 'Students build a plan for making the game, with time and resources established every step. All members of the group should be able to follow it without asking questions.' },
    { code: 'Cii', task: 'Demonstrate technical skill',
      blurb: 'Students demonstrate technical skill while making their game. They choose which skills to highlight, and provide evidence of their work for consideration.' },
    ...
    { code: 'Civ', task: 'Document and explain changes',
      blurb: 'Students record all the changes they make to the design while building it. They explain why each change was needed and the result of the change.' },
    { code: 'Di', task: 'Design testing methods',
      blurb: 'Students design testing methods that produce real data about their game. They will use the methods established to gather data.' },
    { code: 'Dii', task: 'Evaluate against the specifications',
      blurb: 'Students test the finished game and evaluate it against their own specifications. Every success criterion is judged on the evidence the testing produced.' },
    ...
    { code: 'Div', task: 'Explain the impact of their game',
      blurb: 'Students present their work to their client group and target audience. They observe and explain the impact of the finished game, explaining how it was received and noting any remaining feedback.' }
  ];
